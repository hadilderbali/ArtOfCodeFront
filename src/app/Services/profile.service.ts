...
export class ProfileService {
  ...
  addProfile(profileData: FormData): Observable<any> {
    ...
    return this.http.post<any>('http://192.168.33.10:8089/user/api/v1/auth/profile/add', profileData, { headers });
  }
  ...
  getUserById(id:any){
    return this.http.get<any>(`http://192.168.33.10:8089/user/api/v1/auth/user/${id}`)
  }
}
